...
{
    name = debugName;
    //DEBUG(dbgSynch, "Semaphore with name " << this->name << " created.");
    value = initialValue;
...
Semaphore::~Semaphore()
{
    //DEBUG(dbgSynch, "Semaphore with name " << this->name << " destroyed.");
    delete queue;
}
...
Semaphore::P()
{
    DEBUG(dbgSynch, "Semaphore with name " << this->name << " decrements");
    Interrupt *interrupt = kernel->interrupt;
    Thread *currentThread = kernel->currentThread;
    
    // disable interrupts
    IntStatus oldLevel = interrupt->SetLevel(IntOff);	
    DEBUG(dbgSynch, "Disable interrupts successfully");
    ...
    DEBUG(dbgSynch, "Reenable interrupts successfully");	
}
...
Semaphore::V()
{
    DEBUG(dbgSynch, "Semaphore with name " << this->name << " increments");
    Interrupt *interrupt = kernel->interrupt;
